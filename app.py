...
from views import calculator, codegen_lab, hangman, home, password_generator
...
with st.sidebar:
    ...
    page = st.radio(
        "Navigate",
        [PAGE_HOME, PAGE_CALCULATOR, PAGE_CODEGEN, PAGE_PASSWORD, PAGE_HANGMAN],
